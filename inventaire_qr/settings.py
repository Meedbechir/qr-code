...
SECRET_KEY = 'django-insecure-@5sq&3gx_w8g*9pnzuue+-1b$m$ax*-+#x7r%ngfghj8(uik$a'
...
ROOT_URLCONF = 'inventaire_qr.urls'
...
WSGI_APPLICATION = 'inventaire_qr.wsgi.application'
